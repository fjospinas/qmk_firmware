...
enum planck_layers { _QWERTY, _COLEMAK, _DVORAK, _LOWER, _RAISE, _PLOVER, _MOV, _NUM, _ADJUST };
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | Ctrl | Alt  | GUI  |Lower |    Space    |Raise |   /  | Left | Down |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_LCTL, KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_RSFT, SPCMOV,  RAISE,   KC_SLSH, KC_LEFT, KC_DOWN, KC_RGHT
),
...
[_COLEMAK] = LAYOUT_planck_grid(
    ...
    TABNUM,  KC_A,    KC_R,    KC_S,    KC_T,    KC_D,    KC_H,    KC_N,    KC_E,    KC_I,    KC_O,    KC_QUOT,
...
[_DVORAK] = LAYOUT_planck_grid(
    ...
    TABNUM,  KC_A,    KC_O,    KC_E,    KC_U,    KC_I,    KC_D,    KC_H,    KC_T,    KC_N,    KC_S,    KC_SLSH,
    KC_LSFT, KC_SCLN, KC_Q,    KC_J,    KC_K,    KC_X,    KC_B,    KC_M,    KC_W,    KC_V,    KC_Z,    KC_ENT ,
    KC_LCTL, KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_RSFT, SPCMOV,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
* |      |      |      |      |      | PgUp |      |      |      |      |      |  Del |
* |------+------+------+------+------+-------------+------+------+------+------+------|
* | Bksp | Home | End  | Shift| Ctrl |PgDown| Left | Down |  Up  | Right|      |      |
* |------+------+------+------+------+------|------+------+------+------+------+------|
* |      |      |      | CAPS |      |      |      |      |      |      |      |      |
* |------+------+------+------+------+------+------+------+------+------+------+------|
* |      |      |      |      |      |   *******   |      |      |      |      |      |
...
[_MOV] = LAYOUT_planck_grid(
    _______, _______, _______, _______, _______, KC_PGUP, _______, _______, _______, _______, _______, KC_DEL,
    KC_BSPC, KC_HOME, KC_END , KC_LSFT, KC_LCTL, KC_PGDN, KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, _______, _______,
...
[_NUM] = LAYOUT_planck_grid(
    _______, _______, _______, _______, _______, _______, _______, KC_7,    KC_8,    KC_9,    KC_PAST, KC_DEL,
