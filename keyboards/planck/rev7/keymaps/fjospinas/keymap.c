...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_CAPS, KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_RSFT, SPCMOV,  RAISE,   KC_SLSH, KC_LEFT, KC_DOWN, KC_RGHT
),
...
[_DVORAK] = LAYOUT_planck_grid(
    ...
    KC_CAPS, KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_RSFT, SPCMOV,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
